...
it('failed lazy route retains navigation, hides raw error and recovers on another route',async()=>{
 ...
 try {
  ...
  const link=host.querySelector<HTMLAnchorElement>('nav[aria-label="Primary navigation"] a[href="/dashboard"]');
