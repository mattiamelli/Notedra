...
describe('topic learning routes and modes',()=>{
 ...
 it('completed IP modes retain overview/map and show real study content with honest unavailable global features',async()=>{
  ...
  await click('#study-mode-3');expect(container.textContent).toContain('Card 1 of 10');expect(container.querySelector('#card-prompt')).not.toBeNull();await click('#study-mode-4');expect(container.querySelectorAll('.ds-practice-card')).toHaveLength(9);
