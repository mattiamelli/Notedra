...
const files = ['src/AssemblyWorkbench.tsx', 'src/components/CodeEditor.tsx', 'src/components/ControlPanel.tsx', 'src/components/RegisterPanel.tsx', 'src/components/StackVisualizer.tsx', 'src/components/ExecutionHistory.tsx', 'src/components/InstructionExplanation.tsx', 'src/engine/cpu.ts', 'src/engine/executor.ts', 'src/engine/instructions.ts', 'src/engine/memory.ts', 'src/engine/parser.ts', 'src/engine/session.ts', 'src/engine/types.ts', 'src/utils/useSimulator.ts', 'tests/executor.test.ts', 'tests/instructions.test.ts', 'tests/parser.test.ts'];
