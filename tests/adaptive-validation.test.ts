...
it('dedicated gates validate migration versions, all 249 bindings and canonical action projection',()=>{expect(validateMistakes()).toEqual({schema:3,db:3,atomicItems:249});expect(validateAdaptive().skills).toBe(147);});
