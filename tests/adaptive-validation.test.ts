...
it('dedicated gates validate migration versions, all 100 bindings and canonical action projection',()=>{expect(validateMistakes()).toEqual({schema:2,db:2,atomicItems:100});expect(validateAdaptive().skills).toBe(147);});
