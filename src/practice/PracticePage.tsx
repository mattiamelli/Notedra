...
export function PracticePage() {
  ...
  return <><PageHeading eyebrow="AUTHORED PRACTICE" title="Practice"><p>{catalog.length} authored exercises. Save your work and get deterministic feedback, one item at a time.</p></PageHeading>
    <p>Automatically graded items are listed here. Guided proof and construction self-checks, plus interactive workspaces, are available inside each <Link className="ds-text-link" to="/rl">Reasoning & Logic topic</Link>.</p>
