...
export function PracticePage() {
  ...
  return <><PageHeading eyebrow="AUTHORED PRACTICE" title="Practice"><p>{catalog.length} authored exercises. Save your work and get deterministic feedback, one item at a time.</p></PageHeading>
    <p>Automatically graded items are listed here. For guided reasoning, construction, programming and interactive workspaces, explore the topics in <Link className="ds-text-link" to="/co">Computer Organisation</Link>, <Link className="ds-text-link" to="/rl">Reasoning & Logic</Link> or <Link className="ds-text-link" to="/ip">Introduction to Programming</Link>.</p>
    ...
    {filtered.length===0&&<p role="status">No authored exercises match this filter. <Link to="/practice">Return to the catalog</Link>.</p>}
