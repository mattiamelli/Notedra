...
export interface Evidence {id:string;filename:string;pages:number[];section:string;authority:'OFFICIAL_LECTURE'|'OFFICIAL_ASSESSMENT'|'OFFICIAL_PRACTICE_MATERIAL'|'COURSE_TEXTBOOK'|'REFERENCE_TEXTBOOK';skillIds:string[];}
