...
export default function AssemblyWorkbench() {
  ...
  return <div className="app-shell">
    <main>
      ...
      <footer className="app-footer"><span><span className="footer-brand">DelftStudy</span>Made for the moments when assembly clicks.</span><span><kbd>Alt</kbd> + <kbd>←</kbd> / <kbd>→</kbd> to step<span className="footer-dot">·</span>Simplified x86-64 · no data leaves your browser</span></footer>
    </main>
  </div>;
}
