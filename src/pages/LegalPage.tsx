...
export function LegalPage({kind}:{kind:LegalKind}) {
  if(kind==='privacy')return <article className="ds-legal">
    ...
    <section><h2>Local storage, cloud sync, and backups</h2><p>Notedra uses browser storage for account separation, appearance preferences, saved work, and anonymous progress. Signed-in learners can synchronize supported records with Supabase. You can export a JSON backup from Account &amp; sync. Importing a backup replaces the current local profile after an explicit confirmation and keeps a local recovery copy.</p></section>
