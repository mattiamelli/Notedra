...
export default function Assignments({topicId,examOnly=false}:{topicId:string;examOnly?:boolean}){
 ...
 return <section className="ds-section ds-ip-assignments" aria-labelledby="ip-assignments-title"><h2 id="ip-assignments-title">{examOnly?'Authored exam-style practice':'Coding practice · 15 / 30 / 60 minutes'}</h2><p>Original DelftStudy tasks. Suggested time is a practice design choice, not official exam timing. Work through requirements and review component evidence; there is no overall score.</p>
