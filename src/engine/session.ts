...
import { AssemblyError, type CPUState, type Program, type Registers, type StepResult } from './types';
...
export const createSession = (program: Program, input = '', initialRegisters:Partial<Registers>={}): Session => Object.freeze({initial: createCPU(program.entry, initialRegisters, program, input), steps: Object.freeze([]), cursor: 0});
